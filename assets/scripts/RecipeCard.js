...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		const markupData = document.createElement('article');
		...
		shadow.appendChild(markupData);
		shadow.appendChild(styleData);
	...
	set data(data) {
		...
		const artcl = this.shadowRoot.querySelector(`article`);
		...
		artcl.innerHTML = `<img src="${data.imgSrc}" alt="${data.imgAlt}">
  <p class="title">
